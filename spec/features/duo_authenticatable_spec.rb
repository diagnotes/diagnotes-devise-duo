...
describe "Duo Autnenticatable", :type => :request do
  ...
  describe "If user have two factor authentication" do
    ...
    it "Sign in should succeed" do
      ...
      current_path.should == user_verify_duo_path
      page.should have_content('Please enter your Duo token')

      within('#devise_duo') do
        fill_in 'duo-token', :with => '0000000'
      end
      click_on 'Check Token'
      current_path.should == root_path
      page.should have_content(I18n.t('devise.devise_duo.user.signed_in'))
      @user.reload
    ...
    it "Sign in shouldn't succeed" do
      ...
      within('#devise_duo') do
        fill_in 'duo-token', :with => '324567'
      end
      click_on 'Check Token'
      current_path.should == user_verify_duo_path
      @user.reload
      @user.last_sign_in_with_duo.should be_nil
    end
